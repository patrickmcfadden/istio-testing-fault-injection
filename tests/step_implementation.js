...
step("Open bookinfo application", async function () {
    await goto(`http://${baseHost}/productpage`);
});
...
step("Sign in as <user>", async function(user) {
    await click(button("Sign in"))
    await write(user, into(textBox("User Name")));
    await click(button("Sign in"))
